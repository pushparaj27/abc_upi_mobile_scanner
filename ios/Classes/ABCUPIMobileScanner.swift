...
typealias ABCUPIMobileScannerCallback = ((Array<Barcode>?, Error?, UIImage) -> ())
typealias TorchModeChangeCallback = ((Int?) -> ())
typealias ZoomScaleChangeCallback = ((Double?) -> ())

public class ABCUPIMobileScanner: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate, FlutterTexture {
    ...
    let mobileScannerCallback: ABCUPIMobileScannerCallback
    ...
    init(registry: FlutterTextureRegistry?, mobileScannerCallback: @escaping ABCUPIMobileScannerCallback, torchModeChangeCallback: @escaping TorchModeChangeCallback, zoomScaleChangeCallback: @escaping ZoomScaleChangeCallback) {
