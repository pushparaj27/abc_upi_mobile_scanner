...
public class ABCUPIMobileScannerPlugin: NSObject, FlutterPlugin, FlutterStreamHandler, FlutterTexture, AVCaptureVideoDataOutputSampleBufferDelegate {
...
//    var analyzeMode: Int = 0
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let instance = ABCUPIMobileScannerPlugin(registrar.textures)
