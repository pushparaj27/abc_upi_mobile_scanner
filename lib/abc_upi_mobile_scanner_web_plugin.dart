...
import 'package:abc_upi_mobile_scanner/abc_upi_mobile_scanner_web.dart';
import 'package:abc_upi_mobile_scanner/src/barcode_utility.dart';
import 'package:abc_upi_mobile_scanner/src/enums/camera_facing.dart';
import 'package:abc_upi_mobile_scanner/src/objects/barcode.dart';
import 'package:flutter/services.dart';
import 'package:flutter_web_plugins/flutter_web_plugins.dart';

/// This plugin is the web implementation of abc_upi_mobile_scanner.
/// It only supports QR codes.
class ABCUPIMobileScannerWebPlugin {
  ...
  /// void main() {
  ///   if (kIsWeb) {
  ///     ABCUPIMobileScannerWebPlugin.barCodeReader =
  ///         JsQrCodeReader(videoContainer: ABCUPIMobileScannerWebPlugin.vidDiv);
  ///   }
    ...
    switch (call.method) {
      ...
      default:
        throw PlatformException(
          code: 'Unimplemented',
          details:
              "The abc_upi_mobile_scanner plugin for web doesn't implement "
  ...
  static void registerWith(Registrar registrar) {
    final PluginEventChannel event = PluginEventChannel(
      'dev.adityabirlacapital.abc_upi_mobile_scanner/scanner/event',
      const StandardMethodCodec(),
      registrar,
    );
    final MethodChannel channel = MethodChannel(
      'dev.adityabirlacapital.abc_upi_mobile_scanner/scanner/method',
      const StandardMethodCodec(),
      registrar,
    );
    final ABCUPIMobileScannerWebPlugin instance =
        ABCUPIMobileScannerWebPlugin();
