...
import 'package:abc_upi_mobile_scanner/src/abc_upi_mobile_scanner_controller.dart';
import 'package:abc_upi_mobile_scanner/src/abc_upi_mobile_scanner_exception.dart';
import 'package:abc_upi_mobile_scanner/src/objects/barcode_capture.dart';
import 'package:abc_upi_mobile_scanner/src/objects/abc_upi_mobile_scanner_arguments.dart';
...
class MobileScanner extends StatefulWidget {
  ...
  /// Only set this to true if you are starting another instance of abc_upi_mobile_scanner
...
class _MobileScannerState extends State<MobileScanner>
  ...
  Future<void> _startScanner() async {
    ...
    if (!_controller.autoStart) {
      debugPrint(
        'abc_upi_mobile_scanner: not starting automatically because autoStart is set to false in the controller.',
      );
      return;
    }
